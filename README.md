...
Este projeto foi feito para colocar em prática os conhecimentos em ASP .NET MVC em um site para vendas de lanche funcional. 

Vou criar do zero um site web dinâmico e aprender diversos conceitos relacionados ao desenvolvimento web usando a tecnologia ASP .NET MVC e o Entity Framework Core.
